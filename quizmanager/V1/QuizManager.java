...
public class QuizManager extends AndroidNonvisibleComponent {
    ...
    @SimpleFunction(description = "Add a question with options, the index of the correct answer, and an optional image.")
    public void AddQuestion(String questionText, YailList options, int correctAnswerIndex, String imageUrl, String hint) {
        questions.add(new Question(questionText, options.toStringArray(), correctAnswerIndex-1, imageUrl, hint));
...
//    	Log.i("QuizManager",  currentQuestionIndex + " >= 0 && " + currentQuestionIndex + " < " + questions.size());
    ...
    @SimpleEvent(description = "Triggered when a question is answered. The parameter 'correct' indicates if the answer was correct.")
    public void QuestionAnswered(boolean correct) {
        EventDispatcher.dispatchEvent(this, "QuestionAnswered", correct);
    }
    ...
    private class Question {
        ...
        public Question(String text, String[] options, int correctAnswerIndex, String imageUrl, String hint) {
            this.text = text;
